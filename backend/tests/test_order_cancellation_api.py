...
def test_vendor_cannot_cancel_order(client) -> None:
...
def test_returns_404_when_cancelling_unknown_order(client) -> None:
...
def test_rejects_completed_order_cancellation(client) -> None:
    order_id = uuid4()
